 ...
 */
#ifndef SEVERLESSERVER_HELPER_H
#define SEVERLESSERVER_HELPER_H
...
public:
   ...
   *
   */
  ServerlessServerHelper (std::string protocol, Address address);
