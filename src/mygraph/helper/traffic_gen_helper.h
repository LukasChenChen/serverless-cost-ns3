 ...
 */
#ifndef TRAFFIC_GEN_HELPER_H
#define TRAFFIC_GEN_HELPER_H
...
public:
   ...
   *        to.
   */
  traffic_gen_helper (std::string protocol, Address address);
