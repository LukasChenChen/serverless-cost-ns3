...
public:
  ...
  //TODO: the information carried by the request
  requestTag m_rt;

  uint32_t m_seq {0};      //!< Sequence

  void SetTag(requestTag rt);
   ...
   */
  typedef void (*TracedCallback)(Ptr<const AppClient> httpClient);
...
private:
  ...
  ns3::TracedCallback<Ptr<const AppClient> > m_connectionEstablishedTrace;
  /// The `ConnectionClosed` trace source.
  ns3::TracedCallback<Ptr<const AppClient> > m_connectionClosedTrace;
  /// The `Tx` trace source.
  ...
  ns3::TracedCallback<Ptr<const AppClient>, Ptr<const Packet>  > m_rxMainObjectTrace;
  ...
  ns3::TracedCallback<Ptr<const AppClient>, Ptr<const Packet> > m_rxEmbeddedObjectTrace;
  /// The `Rx` trace source.
