...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b'This is image recognition app...')
        

    def do_POST(self):
        logging.warning('This is image recognition app...')
        start = time.time()
        os.system(cmd)
        ...
        logging.warning('Finish response to image recognition request...')
